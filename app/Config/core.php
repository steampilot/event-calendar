 ...
 */
Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUuvlehbsfvhlbefhbabWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '7685930965745352341235123542496749683645');
 ...
 * Include libs
 */
require_once APPLIBS . 'odan/utils.php';
