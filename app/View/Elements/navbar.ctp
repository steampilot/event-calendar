		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li id="navbar-search-item" class="dropdown navbar-item-primary">
					<a href="#" id="navbar-search-link" accesskey="s" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-search"></i> <?php wh(__('Search')); ?></a>
						...
						<div class='row'>
							<div class='col-md-4'>
								<form id="customer_search" role="form">
									<div class="form-group">
										...
										<input class="form-control" name="data[tnw_id]" id="customer_search_tnw_id" type="text" autocomplete="off" maxlength="255">
										<p class="help-block"></p>
									</div>
									<hr>
									<div class="form-group">
										<label><?php wh(__('Lastname*')); ?></label>
										<input type="text" name="data[lastname]" class="form-control" autocomplete="off" required="required" maxlength="255">
										<p class="help-block"></p>
									</div>
									<div class="form-group">
										<label><?php wh(__('Firstname')); ?></label>
										<input type="text" name="data[firstname]" class="form-control" autocomplete="off" maxlength="255">
										<p class="help-block"></p>
									</div>
									<div class="form-group">
										<label><?php wh(__('Date of Birth / Year')); ?></label>
										<input type="text" name="data[date_of_birth]" class="form-control" autocomplete="off" required="required" maxlength="10">
										<p class="help-block"></p>
									</div>
									<div class="form-group">
										<label><?php wh(__('ZIP')); ?></label>
										<input type="text" name="data[postal_code]" class="form-control" required="required" pattern="\d{4,5}" maxlength="5">
										<p class="help-block"></p>
									</div>
									<br>
									<button type="submit" id="customer_search_submit" class="btn btn-primary"><span class="fa fa-search"></span> <?php wh(__('Search')); ?></button>
									<button type="button" id="customer_search_reset" class="btn btn-default"><span class="fa fa-remove"></span> <?php wh(__('New Search')); ?></button>
									<hr>
							...
							<div class='col-md-8'>
								<div style="overflow:auto; max-height: 460px;">
									<table id="navbar_search_result_table" class="table table-bordered table-hover table-striped table-condensed">
									<thead>
										<tr>
